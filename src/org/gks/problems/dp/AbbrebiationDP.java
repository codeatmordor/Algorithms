 ...
 *
 * Capitalize zero or more of 's lowercase letters. Delete all of the remaining lowercase letters in
 * . Given two strings, a and b , determine if it's possible to a make equal to b as described. If
