...
// PACKAGE/IMPORTS --------------------------------------------------
package org.gks.problems.systemdesign.snakegame;

/*
 * The main class (Game) which keeps the instance of Snake and Board. It’s method “update” needs to
 * be called at a fixed intervals (with the help of user input).
 */
public class Game {
